			...
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
					<div class="header-top-info">
						...
						<a href="mailto:support@gmail.com" ><i class="fa fa-envelope mr-2"></i><span>busenquiry456@gmail.com</span></a>
					</div>
				</div>
			</div>
		</div>
	...
	<nav class="navbar navbar-expand-lg  py-4" id="navbar">
		<div class="container">
		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			...
			?>
			  <a href="ChangePhoto.php"><img src="../Assets/Files/BusOwnerPhoto/<?php echo $row["owner_photo"];?>" width=60 height=60></a>
			</form>
		  </div>
		</div>
	</nav>
