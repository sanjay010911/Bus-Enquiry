...
INSERT INTO `tbl_routestop` (`routestop_id`, `route_id`, `bus_id`, `routestop_name`) VALUES
(19, 2, 4, 'velloorkunnam'),
(20, 2, 6, 'Kolencherry Bus Stand'),
(21, 3, 5, 'Velloor junction'),
(25, 4, 7, 'Arakkunnam'),
(26, 4, 7, 'Thiruvaaniyoor'),
(27, 4, 7, 'Mulanthuruthy');
...
--
ALTER TABLE `tbl_bustiming`
  MODIFY `bustime_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_routestop`
  MODIFY `routestop_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
