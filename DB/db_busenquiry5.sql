...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2022 at 08:18 AM
...
(154, 21, 'Piravom Bus Stand'),
(155, 21, 'Mulakkulam Bus Stop'),
(156, 21, 'Peruva Bus Stop'),
(157, 21, 'Moorkattilppady Bus Stop'),
(158, 21, 'Keezhoor Bus Stop'),
(159, 21, 'Thalayolapparambu'),
(160, 22, 'Peruva Bus Stop'),
(161, 22, 'Kunnapilly Bus Stop'),
(162, 22, 'Keezhoor Bus Stop'),
(163, 22, 'Thalappara Bus Stop'),
(164, 21, 'Thalappara Bus Stop'),
...
--
ALTER TABLE `tbl_bustiming`
  MODIFY `bustime_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
...
--
ALTER TABLE `tbl_routestop`
  MODIFY `routestop_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=189;
